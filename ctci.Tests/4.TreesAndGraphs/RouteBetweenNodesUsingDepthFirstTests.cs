namespace citi.Tests._3.StacksAndQueues
{
    ...
    public class RouteBetweenNodesUsingDepthFirstTests
    {
        [Fact]
        public void CanDetermineRouteAsExpectedWhereRouteExists()
        {
            ...
            // Act
            var route = new RouteBetweenNodesUsingDepthFirst();
            var isRoute = route.IsPathBetweenNodesUsingDepthFirst(graph, node1, node3);
        ...
        public void CanDetermineRouteAsExpectedWhereRouteDoesNotExist()
        {
            ...
            // Act
            var route = new RouteBetweenNodesUsingDepthFirst();
            var isRoute = route.IsPathBetweenNodesUsingDepthFirst(graph, node1, node4);
