...
{
    public class BinarySearchTreeValidatorTransversalTests
    {
        [Fact]
        public void ReturnsTrueWithPerfectBinarySearchTree()
        {
            ...
            // Act
            var validator = new ctci._4.TreesAndGraphs.BinarySearchTreeValidatorTransversal(root);
        ...
        public void ReturnsTrueWithImperfectBinarySearchTree()
        {
            ...
            // Act
            var validator = new BinarySearchTreeValidatorTransversal(root);
            var isValid = validator.IsValid();
